...
titleTemplate: 基于 Livewire v4 的 Laravel 管理面板构建器

hero:
  name: XAdmin
  text: Laravel 管理面板构建器
  tagline: 基于 Livewire v4 和 Tailwind CSS 的现代化管理面板构建器
  image:
    src: /logo.svg
    alt: XAdmin Logo
  actions:
...
features:
  ...
  - icon: /icons/palette.svg
    title: Tailwind CSS
    details: 现代化 UI 设计，完美集成 Laravel 生态系统
  ...
  - icon: /icons/box.svg
    title: 开箱即用
    details: Grid、Form、Auth，快速构建 CRUD 操作
---
